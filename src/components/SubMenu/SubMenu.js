...
const LayoutChanger = () => {
    ...
    return (
        <div className="row">
            <i className="btn-ui lo-box_ico click-up click-opac lo-btn__OFF" onClick={filterClickHandler} ref={icons.grid} key="aa">
                <Icon size={{w: 30, h: 30}} type="grid" ui="ico-hue"/>
            </i>
            <i className="btn-ui lo-box_ico click-up click-opac" onClick={filterClickHandler} ref={icons.row}>
